 ...
 */
    ...
    */
    ...
    public ResponseEntity<EmployeeDTO> editEmployee(@PathVariable(name = "id") Long id, @RequestBody EmployeeDTO employeeDTO) throws Exception {

        Employee updatedEmployee = employeeService.edit(id, employeeDTO);


        EmployeeDTO updatedEmployeeDTO = new EmployeeDTO(updatedEmployee.getId(), updatedEmployee.getFirstName(),
                updatedEmployee.getLastName(), updatedEmployee.getPosition());
